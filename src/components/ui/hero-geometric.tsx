...
export function HeroGeometricShaderBackground({
    color1 = "#60A5FA",
    color2 = "#F8FAFC",
    speed = 0.8,
    className,
...
export default function HeroGeometric({
    ...
    return (
        <div
            className={cn("relative w-full min-h-screen flex flex-col items-center overflow-hidden bg-white text-slate-900", className)}
            style={{ containerType: "size" }}
        >
            {/* Background Shader */}
            <HeroGeometricShaderBackground color1={color1} color2={color2} speed={speed} />

            {/* Content */}
            {(title1 || title2 || description) && (
                <div className="relative z-10 w-full flex-1 flex flex-col items-center justify-center pt-8 pb-8 md:pt-16 md:pb-16">
                    <div className="w-full max-w-[1280px] px-6 flex flex-col items-center">
                        {/* Headline */}
                        <div className="flex flex-col items-center text-center gap-2 md:gap-4 mb-6 md:mb-10">
                            {title1 && (
                                <div className="overflow-hidden">
                                    <motion.h1
                                        ...
                                        className="text-[10cqi] md:text-[6.5cqi] lg:text-[5cqi] leading-[0.95] tracking-tight text-white/90"
                                    >
                            ...
                            {title2 && (
                                <div className="overflow-hidden">
                                    <motion.h1
                                        ...
                                        className="text-[10cqi] md:text-[6.5cqi] lg:text-[5cqi] leading-[0.95] tracking-tight font-normal text-slate-900"
                                    >
                                        {title2}
                                    </motion.h1>
                                </div>
                        ...
                        {/* Subheadline */}
                        {description && (
                            <div className="max-w-[560px] text-center mb-8">
                                <motion.p
                                    initial={{ opacity: 0, y: 20 }}
                                    animate={{ opacity: 1, y: 0 }}
                                    transition={{ duration: 0.8, delay: 0.5, ease: "easeOut" }}
                                    className="text-base md:text-lg leading-relaxed text-slate-300 font-normal"
                                >
                                    {description}
                                </motion.p>
                            </div>
